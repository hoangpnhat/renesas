export enum BuiltInToolNames {
  ...
  // RICA multi-agent: orchestrator delegates work to sub-agents via these
  // tools. SpawnAgents is the parallel-batch variant. AnalyzeTask is the
  // orchestrator-only planning tool (file-size/complexity recon before spawn).
  SpawnAgent = "spawn_agent",
  SpawnAgents = "spawn_agents",
  AnalyzeTask = "builtin_analyze_task",
}
