...
// RICA product identity. The literal lives in the overlay
// (rica/adapters/llm/identity.ts) to keep this upstream-managed file clean;
// re-exported here so existing `core/llm/defaultSystemMessages` import paths
// (core + gui) keep working.
export { RICA_IDENTITY } from "../../rica/adapters/llm/identity";
