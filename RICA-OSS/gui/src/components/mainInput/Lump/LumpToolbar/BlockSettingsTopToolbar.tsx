...
import { RicaDocsPopover } from "./RicaDocsPopover";
        ...
        {!hasActiveContent && (
          <div className="flex items-center gap-1.5">
            ...
            <div className="relative">
              <ToolTip content="RICA Documents">
                <HoverItem
                  onClick={() => setShowRicaDocs(!showRicaDocs)}
                  px={2}
                >
                  <DocumentTextIcon className="text-description-muted h-3 w-3 hover:brightness-125" />
                </HoverItem>
              </ToolTip>
              {showRicaDocs && (
                <RicaDocsPopover onClose={() => setShowRicaDocs(false)} />
              )}
            </div>
          </div>
        )}
