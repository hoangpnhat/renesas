...
// RICA: doc links point to the RICA docs site (brand.json docs URL), never
// continue.dev. Under RICA, models come from the central RICA Dynamic config —
// these links are informational. (Phase 5.5 branding.)
const RICA_DOCS_URL = "https://rica.global.renesas.com/docs";

const MODEL_DOCS_URLS = {
  chat: {
    learnMore: RICA_DOCS_URL,
    setup: RICA_DOCS_URL,
  },
  autocomplete: {
    learnMore: RICA_DOCS_URL,
