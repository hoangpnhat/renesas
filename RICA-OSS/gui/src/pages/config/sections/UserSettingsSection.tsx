    ...
    <div>
      <div className="flex flex-col">
        ...
        <div className="space-y-6">
          ...
          {/* Experimental Settings — hidden from users (RICA), code kept intact. Flip to `true` to restore. */}
          {false && (
          <div>
              ...
              >
                <div className="flex flex-col gap-x-1 gap-y-4">
                  ...
                  <UserSetting
                    ...
                    description=" RICA will not attempt to use native tool calling and will only use system message tools."
