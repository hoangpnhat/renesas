...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close RICA Sidebar If Chat Already In Focus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close RICA Sidebar If Chat Already In Focus",
  },
  {
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use RICA"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://rica.global.renesas.com/docs",
                  )
                }
              />
              ...
              <ConfigRow
                title="Have an issue?"
                description="Let us know on GitLab and we'll do our best to resolve it"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
              ...
              <ConfigRow
                ...
                description="Visit the RICA project on GitLab to stay up-to-date on the latest developments"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://gitlab.global.renesas.com/ids_ai/rica-oss",
                  )
                }
              />
            </div>
