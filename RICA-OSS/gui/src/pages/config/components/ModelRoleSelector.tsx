                ...
                >
                  {[...models]
                    ...
                    .map((option, idx) => {
                      ...
                      // RICA: rate-limit lock parity. Show "NN% blocked
                      // (countdown)" and prevent selection when the backend
                      // reports this model's consumption window as blocked.
                      ...
                      const optionDisabled = isConfigInvalid || isBlocked;
                      ...
                      return (
                        <ListboxOption
                          ...
                          onClick={(e: any) =>
                            handleOptionClick(optionDisabled, e)
                          }
                          ...
                          <div className="flex w-full items-center justify-between gap-2">
                            <div className="flex min-w-0 flex-1 items-center gap-2">
                              ...
                              >
                                ...
                                {showUsage && (
                                  <span
                                    className={`ml-2 ${getUsageColor(percent, isBlocked)}`}
                                  >
                                    {percent}%
                                  </span>
                                )}
