...
export type ConsumptionLimit = z.infer<typeof consumptionLimitSchema>;
...
export const modelDescriptionSchema = z.object({
  ...
  consumptionLimit: consumptionLimitSchema.optional(),
  multiAgentEligible: z.boolean().optional(),
});
