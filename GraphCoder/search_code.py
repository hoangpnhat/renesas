...
if __name__ == '__main__':
    ...
    args_parser.add_argument('--query_cases', default="api_level.python", type=str)
    ...
    build_query_subgraph("test.jsonl")
    query_cases = load_jsonl(os.path.join(CONSTANTS.query_graph_save_dir, "test.jsonl"))
