...
void CpuModeOutput(int mode,interface_t* param)
{
  ...
  switch(mode){ /* mode�ɉ�����param�̏o�͂�ύX */
    case MNORMAL:
  ...
  ParamConditionDisp( param_mode, bmecr_mode, param); //param�̃��W�X�^�{Other���o��
...
int VrsgAnalyze(int Vresult[BGR_ARRAY_REPEAT], int *Vanalyze)
{
  ...
  //for(i=0;i<=(BGR_ARRAY_VCC-1);i++){
    ...
    if(Vnum >= (BGR_ARRAY_REPEAT/5)){ //����񐔂�5���ȉ��̃��j�^�[�s��FAIL�Ƃ���B
      //���ό��ʏo�́@����������
      *Vanalyze = Vsum/Vnum;
