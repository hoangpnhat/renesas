 // *********************************************************************** FILENAME RX200fnc.h  CONTENTS: This is the 90nm(RC03F) FLASH module function program for the V3300,4000,5000 test system COPYRIGHT 2007 Renesas Technology ALL RIGHTS RESERVED 2008/11/01  rev.00  1'st created by H.Kobori ***********************************************************************
#ifndef FNC_H
#define FNC_H
...
//extern void RegConditionDisp(int,interface_t*);    // 폜\ => ParamConditionDispɈڍs
