// ****************************************************************************
// ! @file RC04EXslc_Fken.c @brief This is a 130nm(RC01SN) FLASH module user interface program for the 4000,5000 test system @author T.Morioka @date 2012.04.16 Rev.00
// ****************************************************************************
...
//  CpuModeFunc(MNORMAL,MSNORMAL,&vs[0],W1SEC*waittime,param,CreatePatFileName("readdump_code_at"),"CPU Vth-READ ALL");
  ...
  fprintf(file_log,"%d,%d,%d,",info[11],info[12],info[20]);
  // X,Y,Sample
...
// **   Register Log Out                                                             **
// ************************************************************************************
  fprintf(file_log,"%X,",GetValue(OUT_ETLR08,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR10,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR12,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR14,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR16,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR18,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR20,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR22,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR24,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR26,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR28,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR30,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR32,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR34,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR36,param)); f
  fprintf(file_log,"%X,",GetValue(OUT_ETLR38,param)); f
  fprintf(file_log,"");
