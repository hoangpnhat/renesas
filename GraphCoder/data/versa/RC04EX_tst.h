// ****************************************************************************
// FILENAME    RX200tst.h CONTENTS: This is a RC01SN FLASH module voltage monitor subroutine program heddar for the V3300,4000,5000 test system COPYRIGHT 2007 Renesas Technology ALL RIGHTS RESERVED 2010/07/22  rev.00  1'st created by S.Jinbo
// ****************************************************************************
#ifndef TST_H
#define TST_H
...
extern int MONIvsTap(int,int[],int waittime, interface_t* param);
//Add 2018/0420
...
typedef struct {
    ...
    // Target Mat
    char mem;
    // Target mem DATA/ECC/LK/BP/ECCON/(Posi/Nega) = bit0/bit1/bit2/bit3/bit4/(bit5/bit6)
    char func;
    // Target Function
    int vcc;
    // Test VCC
...
#define BT_SAMPLING         0x00000400
// Sampling Data Logging
#define BT_AT_FAIL_FUNC     0x00008000
#define BT_PASS_RETEST      0x00020000
// Read P1 Code PASS Device Test
