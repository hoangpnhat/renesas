/******************************************************************************/
/*!
  @file RX200slc_MonitorTrimingSelect.c
...
int MonitorTrimingSelect(int vs[NUM_POWERSUPPLY],int waittime,interface_t* param)
{
  ...
  int trimvalue[V_VPP_TF+1]; /* Triming Target Voltages */
  ...
  for(cnt=1;cnt<=V_VPP_TF;cnt++){    /* INITIALIZE All vol[n]              */
    vol[cnt] = 0;
  }
  for(cnt=1;cnt<=V_VPP_TF;cnt++){       /* INITIALIZE All trimvalue[n]        */
    trimvalue[cnt] = 0;
  }
  ...
  /****************************************************************************/
  /* Set Auto Triming Target Value 旧製品                                     */
  /****************************************************************************/
  ...
  etcr11_bak = SetValue(IN_ETCR11,param,(GetValue(IN_ETCR11,param) | 0x04)); // ETCR11[2] CountStop
  ...
  while((test_cond != QUIT)&&(test_cond != EXIT)){
    ...
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("|  2|ATB                |%6dmV| |  CH2  |        |  -  |   -  |   -  |   -  |   -  |\n",vol[V_BGR08]); //仮版待ち
    printf("|  3|VDD                |%6dmV| |VCLMON |        |  -  |   -  |   -  |  503 |   -  |\n",vol[V_VDD]);
    printf("|  4|VDDH               |%6dmV| |VCLMON |        |  -  |   -  |   -  |  504 |   -  |\n",vol[V_VDDH]);
    printf("|  5|Vref10             |%6dmV| |VSSMON |%6dmV|  -  |   -  |   -  |  505 |   -  |\n",vol[V_VREF10],trimvalue[V_VREF10]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("|  7|vpp (Erase)        |%6dmV| |VSSMON |%6dmV|  -  |   -  |  507 |   -  |   -  |\n",vol[V_VPP_E],trimvalue[V_VPP_E]);
    printf("|  8|vpp (Write)        |%6dmV| |VSSMON |%6dmV|  -  |   -  |  508 |   -  |   -  |\n",vol[V_VPP_P],trimvalue[V_VPP_P]);
    printf("|  9|vpp (Pre-Write)    |%6dmV| |VSSMON |%6dmV|  -  |   -  |  509 |   -  |   -  |\n",vol[V_VPP_PW],trimvalue[V_VPP_PW]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("| 21|Vhh (Erase)        |%6dmV| |VCCMON |%6dmV|  -  |   -  |  521 |   -  |  721 |\n",vol[V_VHH_E],trimvalue[V_VHH_E]);
    printf("| 22|Vhh (Write)        |%6dmV| |VCCMON |%6dmV|  -  |   -  |  522 |   -  |  722 |\n",vol[V_VHH_P],trimvalue[V_VHH_P]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("| 30|Vrsg               |%6dmV| |VCCMON |%6dmV|  -  |   -  |  530 |   -  |   -  |\n",vol[V_VRSG],trimvalue[V_VRSG]);
    printf("| 31|V33r               |%6dmV| |VCCMON |%6dmV|  -  |   -  |  531 |   -  |   -  |\n",vol[V_V33R],trimvalue[V_V33R]);
    printf("| 32|Vwi                |%6dmV| |VCCMON |%6dmV|  -  |   -  |  532 |   -  |   -  |\n",vol[V_VWI],trimvalue[V_VWI]);
    printf("| 33|Vdemg              |%6dmV| |VSSMON |%6dmV|  -  |   -  |  533 |   -  |   -  |\n",vol[V_VDEMG],trimvalue[V_VDEMG]); //Add trim VDEMG 2018/0327
    printf("| 34|Vreg20             |%6dmV| |VCCMON |   --   |  -  |   -  |   -  |   -  |   -  |\n",vol[V_VREG20]);
    //printf("| 35|Vnoemi             |%6dmV| |VCCMON |%6dmV|  -  |   -  |   -  |   -  |   -  |\n",vol[V_VNOEMI],trimvalue[V_VNOEMI]);
    printf("| 36|Vnoemi(PE)         |%6dmV| |VCCMON |%6dmV|  -  |   -  |  536 |   -  |   -  |\n",vol[V_VNOEMI_PE],trimvalue[V_VNOEMI_PE]);
    //printf("| 37|Vnoemi(Read)       |%6dmV| |VCCMON |%6dmV|  -  |   -  |   -  |   -  |   -  |\n",vol[V_VNOEMI_R],trimvalue[V_VNOEMI_R]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("| 40|imoni(I01U)  notemp|%6dnA| |VSSMON |%6dnA|  -  |   -  |  540 |   -  |   -  |\n",vol[I_IMONI_I01U_NOTEMP],trimvalue[I_IMONI_I01U_NOTEMP]);
    printf("| 41|imoni(Flash) notemp|%6dnA| |VSSMON |%6dnA|  -  |   -  |  541 |   -  |   -  |\n",vol[I_IMONI_FLASH_NOTEMP],trimvalue[I_IMONI_FLASH_NOTEMP]);
    printf("| 42|imoni(I01U)  temp  |%6dnA| |VSSMON |%6dnA|  -  |   -  |  542 |   -  |   -  |\n",vol[I_IMONI_I01U_TEMP],trimvalue[I_IMONI_I01U_TEMP]);
    printf("| 43|imoni(Flash) temp  |%6dnA| |VSSMON |%6dnA|  -  |   -  |  543 |   -  |  743 |\n",vol[I_IMONI_FLASH_TEMP],trimvalue[I_IMONI_FLASH_TEMP]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("| 50|OSC_32MHz          |%d.%03dMHz| |   -   |%6dus|  -  |   -  |  550 |   -  |   -  |\n",vol[T_OSC32]*4/trimvalue[T_OSC32],(vol[T_OSC32]*4%trimvalue[T_OSC32])*1000/trimvalue[T_OSC32],trimvalue[T_OSC32]);
    printf("| 51|OSC_1MHz           |%d.%03dMHz| |   -   |%6dus|  -  |   -  |  551 |   -  |   -  |\n",vol[T_OSC1]/trimvalue[T_OSC1],(vol[T_OSC1]%trimvalue[T_OSC1])*1000/trimvalue[T_OSC1],trimvalue[T_OSC1]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("| 60|ReadDelay 8ns FLP0 |%6dns| |VSSMON |%6dns|  -  |   -  |  562 |   -  |   -  |\n",vol[T_READDELAY8_FLP0],trimvalue[T_READDELAY8]);
    printf("|   |              FLI1 |%6dns| |VSSMON |%6dns|  -  |   -  |  563 |   -  |   -  |\n",vol[T_READDELAY8_FLI1],trimvalue[T_READDELAY8]);
    printf("|   |              FLI2 |%6dns| |VSSMON |%6dns|  -  |   -  |  564 |   -  |   -  |\n",vol[T_READDELAY8_FLI2],trimvalue[T_READDELAY8]);
    printf("| 61|ReadDelay10ns FLP0 |%6dns| |VSSMON |%6dns|  -  |   -  |  565 |   -  |   -  |\n",vol[T_READDELAY10_FLP0],trimvalue[T_READDELAY10]);
    printf("|   |              FLI1 |%6dns| |VSSMON |%6dns|  -  |   -  |  566 |   -  |   -  |\n",vol[T_READDELAY10_FLI1],trimvalue[T_READDELAY10]);
    printf("|   |              FLI2 |%6dns| |VSSMON |%6dns|  -  |   -  |  567 |   -  |   -  |\n",vol[T_READDELAY10_FLI2],trimvalue[T_READDELAY10]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("| 70|Vpp Tf (Only Trim) |%3d.%d ns| |   -   |%6dus|  -  |   -  |  670 |   -  |   -  |\n",vol[V_VPP_TF]/1000,(vol[V_VPP_TF]/100)%10,trimvalue[V_VPP_TF]);
    printf("+---+-------------------+--------+ +-------+--------+-----+------+------+------+------+\n");
    printf("+---------------------------------------------------------------------------------------------------------------+\n");
    //printf("| Monitor All(99)  Manual Triming ALL (299) ※Manual Trimは未定                                               |\n");
...
/*
      printf("Reg Set Mon\n");
      MONIvsTap(test_cond-500,&vs[0],waittime,param);
    }else if((test_cond==721) || (test_cond==722)){
      MONIvsTap(test_cond,&vs[0],waittime,param);
*/
    }
    switch(test_cond){
    case EXIT:                          /***** Exit ***************************/
      SetValue(IN_ETCR11,param,etcr11_bak); // ETCR11[2] CountStop
      return(PASS);
      break;
    case QUIT:                          /***** Quit ***************************/
    ...
    case 50:
      ...
      printf( " OCC(ETCR15&14) = 0x%04X ->> %d[cyc]\n", GetValue(OUT_LDATA0,param), result );
      vol[T_OSC32] = result;
      break;
    ...
    case 61:
      ...
      SetValue(IN_LDATA0,param,100*10000); /* 100ms(10000*100ns=1ms) */
      if(test_cond==60){
        printf("MONITOR Read Delay8\n");
        SetValue(IN_TESTSEL,param,AUTOTRIM_READDELAY8);  /* AUTOTRIM_READDELAY8 = MONITOR_READDELAY8 */
        i = 0;
      }else{
        printf("MONITOR Read Delay10\n");
        SetValue(IN_TESTSEL,param,AUTOTRIM_READDELAY10); /* AUTOTRIM_READDELAY10 = MONITOR_READDELAY10 */
        i = 1;
      }
    ...
    case 99: /* Monitor ALL */
      ...
      SetValue(IN_TESTSEL,param,99);//電圧系全てモニター
      SetValue(IN_LDATA0,param,12); //12回目で電流モニターに移行
      SetValue(IN_BDATA05,param,13);//14回Repeat
      SetValue(IN_LDATA1,param,7);  //7回目でVSSMONに切り替え
      ...
      // Monitor Vpp Pre-Write
      printf("MONITOR Vpp Pre-Write\n");
      SetValue(IN_TESTSEL,param,MONITOR_VPP_PW);
      CpuModeMonitor(VSSMON_MON,&vs[0],param,W1SEC*waittime,CreatePatFileName("monitorvoltage_at"),"MONITOR_V_VPP_PW",&selvol);
      vol[V_VPP_PW] = selvol;
      ...
      printf("MONITOR Vrsg\n");
      SetValue(IN_TESTSEL,param,MONITOR_VRSG);
      CpuModeMonitor(VCCMON_MON,&vs[0],param,W1SEC*waittime,CreatePatFileName("monitorvoltage_at"),"MONITOR_V_VRSG",&selvol);
      vol[V_VRSG] = selvol;

      // Monitor V33r
      printf("MONITOR V33R\n");
      SetValue(IN_TESTSEL,param,MONITOR_V33R);
      CpuModeMonitor(VCCMON_MON,&vs[0],param,W1SEC*waittime,CreatePatFileName("monitorvoltage_at"),"MONITOR_V_V33R",&selvol);
      vol[V_V33R] = selvol;

      // Monitor Vwi
      printf("MONITOR Vwi\n");
      SetValue(IN_TESTSEL,param,MONITOR_VWI);
      CpuModeMonitor(VCCMON_MON,&vs[0],param,W1SEC*waittime,CreatePatFileName("monitorvoltage_at"),"MONITOR_V_VWI",&selvol);
      vol[V_VWI] = selvol;

      // Monitor Vdemg
      printf("MONITOR Vdemg\n");
      SetValue(IN_TESTSEL,param,MONITOR_VDEMG);
      CpuModeMonitor(VSSMON_MON,&vs[0],param,W1SEC*waittime,CreatePatFileName("monitorvoltage_at"),"MONITOR_V_VDEMG",&selvol);
      vol[V_VDEMG] = selvol;
      ...
      printf("MONITOR Vnoemi(PE)\n");
      SetValue(IN_TESTSEL,param,MONITOR_VNOEMI_PE);
      CpuModeMonitor(VCCMON_MON,&vs[0],param,W1SEC*waittime,CreatePatFileName("monitorvoltage_at"),"MONITOR_VNOEMI_PE",&selvol);
      vol[V_VNOEMI_PE] = selvol;
      */
    ...
    case 207:
      printf("AutoTrim Vpp Erase:%06d[mV]\n", trimvalue[V_VPP_E]);
    ...
    case 208:
      printf("AutoTrim Vpp Write:%06d[mV]\n", trimvalue[V_VPP_P]);
    ...
    case 209:
      printf("AutoTrim Vpp Pre-Write:%06d[mV]\n", trimvalue[V_VPP_PW]);
    ...
    case 221:
      printf("AutoTrim Vhh Erase:%06d[mV]\n", trimvalue[V_VHH_E]);
    ...
    //case 233: /* Vdemgはトリミングしない(テストファームも未対応) */
    //  printf("AutoTrim Vdemg:%06d[mV]\n", trimvalue[V_VDEMG]);
    ...
    case 236:
      printf("AutoTrim Vnoemi(PE)\n", trimvalue[V_VNOEMI_PE]);
    ...
    //case 237: /* Vnoemi(Read)はトリミングしない(テストファームも未対応) */
    //  printf("AutoTrim Vnoemi(Read)\n", trimvalue[V_VNOEMI_R]);
    ...
    case 240:
      printf("AutoTrim inmoni(I01U) notemp:%06d[nA]\n", trimvalue[I_IMONI_I01U_NOTEMP]);
    ...
    case 241:
      printf("AutoTrim inmoni(Flash) notemp:%06d[nA]\n", trimvalue[I_IMONI_FLASH_NOTEMP]);
    ...
    case 242:
      printf("AutoTrim inmoni(I01U) temp:%06d[nA]\n", trimvalue[I_IMONI_I01U_TEMP]);
    ...
    case 243:
      printf("AutoTrim inmoni(Flash) temp:%06d[nA]\n", trimvalue[I_IMONI_FLASH_TEMP]);
    ...
    case 250:
      printf("AutoTrim OSC_32MHz:%d[us]\n", trimvalue[T_OSC32]);
      ...
      result = 0xFFFF-GetValue(OUT_LDATA0,param);
      printf( " OCC(ETCR15&14) = 0x%04X ->> %d[cyc]\n", GetValue(OUT_LDATA0,param), result );
      printf( " HOSC = %d.%03d[MHz]\n", result*4/trimvalue[T_OSC32], (result*4%trimvalue[T_OSC32])*1000/trimvalue[T_OSC32] );
      printf( " ETLR10 = 0x%02X ->> 0x%02X\n", GetValue(IN_ETLR10,param), GetValue(OUT_ETLR10,param) );
      SetValue(IN_ETLR10,param,GetValue(OUT_ETLR10,param));
      break;

    case 251:
      printf("AutoTrim OSC_1MHz:%d[us]\n", trimvalue[T_OSC1]);
      ...
      result = 0xFFFF-GetValue(OUT_LDATA1,param);
      printf( " OCC(ETCR15&14) = 0x%04X ->> %d[cyc]\n", GetValue(OUT_LDATA1,param), result );
      printf( " LOSC = %d.%03d[MHz]\n", result/trimvalue[T_OSC1], (result%trimvalue[T_OSC1])*1000/trimvalue[T_OSC1] );
      printf( " ETLR11 = 0x%02X ->> 0x%02X\n", GetValue(IN_ETLR11,param), GetValue(OUT_ETLR11,param) );
    ...
    case 261:
      ...
      first_flag =1;
      if(test_cond==260){
        printf("AutoTrim Read Delay8:%d[ns]\n", trimvalue[T_READDELAY8]);
        SetValue(IN_TESTSEL,param,AUTOTRIM_READDELAY8);
        i = 0;
      }else{
        printf("AutoTrim Read Delay10:%d[ns]\n", trimvalue[T_READDELAY10]);
      ...
      for(cnt=0; cnt<16*(i+1); cnt++){
        ...
        if(test_cond==260){
          printf(" ETLR26 = 0x%02X\n", GetValue(OUT_ETLR26,param));
          printf(" ETLR27 = 0x%02X\n", GetValue(OUT_ETLR27,param));
        }else{
          printf(" ETLR28 = 0x%02X\n", GetValue(OUT_ETLR28,param));
          printf(" ETLR29 = 0x%02X\n", GetValue(OUT_ETLR29,param));
          printf(" ETLR30 = 0x%02X\n", GetValue(OUT_ETLR30,param));
        }
        ...
        printf(" Status Register(ETCR16[4:2]) = 0x%X\n\n", err_flag);
    ...
    case 270:
      ...
      result = GetValue(OUT_JUDGE1,param);
      if( result==PASS ){
        printf(" ETLR15 = 0x%02X ->> 0x%02X\n", GetValue(IN_ETLR15,param), GetValue(OUT_ETLR15,param));
    ...
    /* Auto Triming ALL                                                       */
    /**************************************************************************/
    case 300:/* Auto Trim ALL は個別のAutoTrim確認後、追加予定 */
      printf("AutoTrim ALL\n");
	  
	  Trim_VddVddh(1,param); // Vdd Trim
	  Trim_VddVddh(2,param); // Vddh Trim
	  DeviceSpecificPowerUp();
      ...
      /* Auto Trim Vpp PreWrite *//* WTでは実施しない為スキップ */
      //printf("AutoTrim Vpp Pre-Write:%06d[mV]\n", trimvalue[V_VPP_PW]);
      //SetValue(IN_TESTSEL,param,AUTOTRIM_VPP_PW);
      //CpuModeMonitor(VSSMON_APP,&vs[0],param,W1SEC*waittime,CreatePatFileName("trimingvoltage_at"),"AUTOTRIM_VPP_PW",&trimvalue[V_VPP_PW]);
      ...
      /* Auto Trim OSC32MHz */
      printf("AutoTrim OSC_32MHz:%d[cyc]\n", trimvalue[T_OSC32]);
      SetValue(IN_TESTSEL,param,AUTOTRIM_OSC32);
      SetValue(IN_LDATA0,param,268*10); /* Target=270us(10*100ns=1us) */
      CpuModeFunc(MNORMAL,MSNORMAL,&vs[0],W1SEC*waittime,param,CreatePatFileName("trimingcycle_at"),"AUTOTRIM_OSC32");
      result = 0xFFFF-GetValue(OUT_LDATA0,param);
      ...
      printf("AutoTrim OSC_1MHz:%d[us]\n", trimvalue[T_OSC1]);
      SetValue(IN_TESTSEL,param,AUTOTRIM_OSC1);
      SetValue(IN_LDATA0,param,98*10); /* Taeget=100us(10*100ns=1us) */
      CpuModeFunc(MNORMAL,MSNORMAL,&vs[0],W1SEC*waittime,param,CreatePatFileName("trimingcycle_at"),"AUTOTRIM_OSC1");
      result = 0xFFFF-GetValue(OUT_LDATA1,param);
      printf( " OCC(ETCR15&14) = 0x%04X ->> %d[cyc]\n", GetValue(OUT_LDATA1,param), result );
      printf( " LOSC = %d.%03d[MHz]\n", result/trimvalue[T_OSC1], (result%trimvalue[T_OSC1])*1000/trimvalue[T_OSC1] );
      ...
      DeviceSpecificPowerUp(); /* DelayTrimのPin設定変更に伴い再設定が必要(通常はメニューインプット時に実施) */
      /* Auto Trim Vpp tf */
      printf("AutoTrim Vpp Tf:%d[us]\n", trimvalue[V_VPP_TF]);
      SetValue(IN_TESTSEL,param,AUTOTRIM_VPP_TF);
      CpuModeFunc(MNORMAL,MSNORMAL,&vs[0],W1SEC*waittime,param,CreatePatFileName("trimingcycle_at"),"AUTOTRIM_VPP_TF");
    ...
    case 301:
      ...
      do{
        ...
        printf("+----+-------------------+----------+\n");
        printf("| (2)|Bgr08              |[%6d]mV|\n",trimvalue[V_BGR08]);
        printf("| (3)|Vdd                |[%6d]mV|\n",trimvalue[V_VDD]);
        printf("| (4)|Vddh               |[%6d]mV|\n",trimvalue[V_VDDH]);
        printf("| (5)|Vref10             |[%6d]mV|\n",trimvalue[V_VREF10]);
        printf("| (7)|Vpp_erase          |[%6d]mV|\n",trimvalue[V_VPP_E]);
        printf("| (8)|Vpp_write          |[%6d]mV|\n",trimvalue[V_VPP_P]);
        printf("| (9)|Vpp_prewrite       |[%6d]mV|\n",trimvalue[V_VPP_PW]);
        printf("|(21)|Vhh_erase          |[%6d]mV|\n",trimvalue[V_VHH_E]);
        printf("|(22)|Vhh_write          |[%6d]mV|\n",trimvalue[V_VHH_P]);
        printf("|(30)|Vrsg               |[%6d]mV|\n",trimvalue[V_VRSG]);
        printf("|(31)|V33r               |[%6d]mV|\n",trimvalue[V_V33R]);
        printf("|(32)|Vwi                |[%6d]mV|\n",trimvalue[V_VWI]);
        //printf("|(33)|Vdemg              |[%6d]mV|\n",trimvalue[V_VDEMG]);
        //printf("|(35)|Vnoemi             |[%6d]mV|\n",trimvalue[V_VNOEMI]); //del 20180329
        printf("|(36)|Vnoemi(PE)         |[%6d]mV|\n",trimvalue[V_VNOEMI_PE]);  
        //printf("|(37)|Vnoemi(Read)       |[%6d]mV|\n",trimvalue[V_VNOEMI_R]);
        printf("|(40)|imoni(I01U)  notemp|[%6d]nA|\n",trimvalue[I_IMONI_I01U_NOTEMP]);
        printf("|(41)|imoni(Flash) notemp|[%6d]nA|\n",trimvalue[I_IMONI_FLASH_NOTEMP]);
        printf("|(42)|imoni(I01U)  temp  |[%6d]nA|\n",trimvalue[I_IMONI_I01U_TEMP]);
        printf("|(43)|imoni(Flash) temp  |[%6d]nA|\n",trimvalue[I_IMONI_FLASH_TEMP]);
        //printf("|(50)|OSC32MHz           |[%6d]us|\n",trimvalue[T_OSC32]);
        //printf("|(51)|OSC1MHz            |[%6d]us|\n",trimvalue[T_OSC1]);
        printf("|(60)|Read Delay8        |[%6d]ns|\n",trimvalue[T_READDELAY8]);
        printf("|(61)|Read Delay10       |[%6d]ns|\n",trimvalue[T_READDELAY10]);
        //printf("|(70)|Vpp Tf             |[%6d]us|\n",trimvalue[V_VPP_TF]);
        printf("+----+-------------------+----------+\n");
        printf("|Return(e)                          |\n");
        printf("+-----------------------------------+\n");
        printf("Select No ->");
    ...
    case 800:
      ...
      while(1){
        ...
        printf("|121|Vhh_E Leak           |\n");
    	   ...
    	   printf("+---+---------------------+\n");
    	   printf("|IN_ETCR03  = 0x%2X (Tap) |\n",GetValue(IN_ETCR03,param));
    	   printf("|IN_BDATA00 = 0x%2X (Tap) |\n",GetValue(IN_BDATA00,param));
    	   printf("+---+---------------------+\n");
    	   printf("|e  |Exit                 +\n");
    	   printf("+---+---------------------+\n");
        ...
        DigitInput(&tempo0);
          ...
          case 121:
            SetValue(IN_TESTSEL,param,AUTOTRIM_VHH_E);
            stack4 = SetValue(IN_LDATA0,param,30*10000); // 30ms(10000*100ns=1ms)
          ...
          case 199:
            ...
            printf("|121|Vhh_E Leak           |\n");
    	       printf("|122|Vhh_W Leak           |\n");
    	       printf("+---+---------------------+\n");
    	       printf("|IN_ETCR03  = 0x%2X       +\n",GetValue(IN_ETCR03,param));
    	       printf("|IN_BDATA00 = 0x%2X       +\n",GetValue(IN_BDATA00,param));
    	       printf("+---+---------------------+\n");
    	       printf("|999|Exit                 +\n");
    	       printf("+---+---------------------+\n");
  ...
  for(i=1;i<=3;i++){
    ...
    DeviceSpecificPowerUp();
    MONIvsTap(221,&vs[0],waittime,param); // VHH E Monitor
    DeviceSpecificPowerUp();
    MONIvsTap(222,&vs[0],waittime,param); // VHH W Monitor
    DeviceSpecificPowerUp();
    MONIvsTap(243,&vs[0],waittime,param); // Iref Monitor
  }
  ...
  vs[2]=500;  //Vdd=0.79V
    DeviceSpecificPowerUp();
    MONIvsTap(223,&vs[0],waittime,param); // VHH W Monitor
