...
#define RELAY_FF      format all_lb nr=0xff                 /* relay ctl=H'ff                     */
#define RELAY_00      format all_lb nr=0x00                 /* relay ctl=H'00                     */
#define RELAY_HZ      format all_lb nc=0                    /* relay ctl=open                     */
...
#define DAXS_DATA_CP  format daxs_datao_ext cn, format daxs_datai nc=0,format debugpin rto = 0 /* data=comp(strobe) d                */
#define DAXS_DATA_DR  format daxs_datai_ext nr, format daxs_datao nc=0 /* data=drive(input) d                */
#define DAXS_DATA_NC  format daxs_datai nr=0, format daxs_datao   nc=0 /* data=drive(input) d                */

/* ------------RAM Boot Control------------------------------------------------------*/
#define BOOT_CTRL1    /*format atb1 nr=0,*/vec,format tms nr=0
