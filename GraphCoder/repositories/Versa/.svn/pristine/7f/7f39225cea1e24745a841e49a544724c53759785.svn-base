...
extern int lb_all_pins[];                /* Relay LB0-7 CH24-31       */
extern int lb0_pin[];                    /* Relay LB0   CH24          */
extern int lb1_pin[];                    /* Relay LB1   CH25          */
extern int lb2_pin[];                    /* Relay LB2   CH26          */
extern int lb3_pin[];                    /* Relay LB3   CH27          */
