 ...
 *        FILENAME        RX200CGR.C
 *
 *        CONTENTS: This is a RX200 pin assagin program for the
 *                        V3300 test system.
 *
...
int delay_test_pins[] = {
        CH6,CH11,       /* DelayTestPinの設定(Vssmon&DelayTest)*/ 
	ENDLST
};

int delay_pin[] = {
        CH6,            /* DelayTestPinの設定(DelayTest)*/ 
	ENDLST
};
int vssmon_pe_pin[] = {
        CH11,            /* DelayTestPinの設定(Vssmons)*/ 
	ENDLST
};
...
int lb_all_pins[] = {
        CH26,CH27,CH28,CH29,CH3,/* Relay LB0-LB3 */
        ENDLST
};

int lb0_pin[]            = { CH26, ENDLST };/* Relay LB0 */
int lb1_pin[]            = { CH27, ENDLST };/* Relay LB1 */
int lb2_pin[]            = { CH28, ENDLST };/* Relay LB2 */
int lb3_pin[]            = { CH29, ENDLST };/* Relay LB3 */
