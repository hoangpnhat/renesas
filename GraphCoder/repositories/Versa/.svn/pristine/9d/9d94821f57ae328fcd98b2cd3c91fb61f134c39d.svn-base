...
/**************************************************************************************/
    ...
    if( NULL==(file_log = fopen( file_name, "at" )) ){
      ...
      switch (i) {
        case 0: loop_num =  0; fprintf(file_log,"Erase"); break;  /* Init */
        case 1: loop_num =  1; fprintf(file_log,"x1   "); break;  /*   x1 */
        case 2: loop_num =  2; fprintf(file_log,"x3   "); break;  /*   x3 */
        case 3: loop_num =  2; fprintf(file_log,"x5   "); break;  /*   x5 */
        case 4: loop_num =  5; fprintf(file_log,"x10  "); break;  /*  x10 */
        case 5: loop_num = 10; fprintf(file_log,"x20  "); break;  /*  x20 */
        case 6: loop_num = 12; fprintf(file_log,"x32  "); break;  /*  x32 */
        case 7: loop_num = 15; fprintf(file_log,"x47  "); break;  /*  x47 */
        case 8: loop_num = 23; fprintf(file_log,"x70  "); break;  /*  x70 */
        case 9: loop_num = 30; fprintf(file_log,"x100 "); break;  /* x100 */
        default: break;
      } 
...
//       SetValue(IN_ETCR08,param,(GetValue(IN_ETCR08,param)&0x1F)|0x20); /* User Sector */
      ...
      if ( i!=0 ) {	/* Write-Inhibit Stress Input */
      ...
      if(adr_mode ==3){
        bit_count = (GetValue(IN_TESTSIZE0,param)+GetValue(IN_TESTSIZE1,param)+GetValue(IN_TESTSIZE2,param)) * 8 / 2; // /2 = RowStripe
      }else{
