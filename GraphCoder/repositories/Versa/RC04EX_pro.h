...
/* 製品変更時の書き換え必須項目                                               */
/*----------------------------------------------------------------------------*/
#define CURRENTDR          "E:\\SOTB_IO"                  /* パタンその他を格納するルートフォルダパス */
#define CURRENTDR_D_DRIVE  "D:\\SOTB_IO"                  /* V5000-3/4 ルートフォルダパス */
#define DEVICENAME         "RC04EX_IO"                    /* デバイス名 16文字以内 ***.pln ファイルのDEVICE_TYPEも同値に変更 */
#define PROGRAMNAME        "RC04EX Rev"
#define RAM_SIZE    0x00004000                        /* 0番地から始まる RAMの使用サイズ *//* SRAM0: 2000 0000 ～ 2000 7FFFh  SRAM1: 2000 8000 ～ 2001 FFFFh */
...
#define PLL_MOUNT     0                 /* PLL回路搭載=1  非搭載=0            */

/*----------------------------------------------------------------------------*/
/* FLIの搭載枚数が同じならば大概書き換え不要                                  */
/*----------------------------------------------------------------------------*/
#define FLI_TOTALCOUNT 1                /* FLP/FLIモジュールの搭載数          */
#define FLP0_TOP    0x00000000          /* FLP0の先頭アドレス                 */
#define FLP0_END    0x0003FFFF          /* FLP0の最終アドレス                 */
#define FLP0_SIZE   0x00040000          /* FLP0の合計メモリサイズ             */
#define FLI1_TOP    0x00000000          /* FLI1の先頭アドレス                 */
#define FLI1_END    0x00000000          /* FLI1の最終アドレス                 */
#define FLI1_SIZE   0x00000000          /* FLI1の合計メモリサイズ             */
#define FLI2_TOP    0x00000000          /* FLI2の先頭アドレス                 */
#define FLI2_END    0x00000000          /* FLI2の最終アドレス                 */
#define FLI2_SIZE   0x00000000          /* FLI2のメモリサイズ                 */

#define EXTRAS_TOP    0x00000000          /* Wmat(Extra5)の先頭アドレス            */
#define EXTRAS_END    0x000003FF          /* Wmat(Extra5)の最終アドレス            */
#define EXTRAS_SIZE   0x00000400          /* Wmat(Extra5)のメモリサイズ            */
#define EXTRAB_TOP    0x00000000          /* Wmat(Extra6)の先頭アドレス            */
#define EXTRAB_END    0x00003FFF          /* Wmat(Extra6)の最終アドレス            */
#define EXTRAB_SIZE   0x00004000          /* Wmat(Extra6)のメモリサイズ            */
...
#define TARGET_IREF_25C      5900       /* Iref=2.5uA Target (2.5uAx3-0.15(adjust)    */
#define TARGET_IREF_F_25C    5900       /* Iref=2.5uA Target (2.5uAx3-0.15(adjust)    */
#define TARGET_IREF_T_25C    5900       /* Iref=2.5uA Target (2.5uAx3-0.15(adjust)    */
#define TARGET_IREF_T_F_25C  5900       /* Iref=2.5uA Target (2.5uAx3-0.15(adjust)    */
...
/* その他DAXS転送など  基本変更不要                                           */
/*----------------------------------------------------------------------------*/
#define INIT_DAXS_WR_RATE  250   /* 2.5MHz */
#define INIT_DAXS_RD_RATE  250   /* 2.5MHz */
...
#define VTHMODE 0 // 0:VthRead New Mode, 1:VthRead Old Mode
