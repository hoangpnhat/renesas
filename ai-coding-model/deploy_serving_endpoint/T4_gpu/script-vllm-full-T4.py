...
# MAGIC %pip install numpy==1.26.4 vllm==0.7.0 transformers==4.53.0 torch accelerate==1.8.1 pandas tiktoken==0.9.0
...
if "qwen" in MODEL_NAME:
    ...
    model_path = os.path.join(os.getcwd(), "./qwencoder_wrapper_T4.py")
    ...
    # python_model = QwenCoderWrapper()
    model_path = os.path.join(os.getcwd(), "./deepseek_wrapper_T4.py")
