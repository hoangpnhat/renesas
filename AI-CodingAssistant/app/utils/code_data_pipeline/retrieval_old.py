...
Settings.embed_model = DatabricksEmbedding(model='text-embedding-3-small')
...
class ParentVectorContextRetriever(BasePGRetriever):
    ...
    #     return self._get_nodes_with_score([x[0] for x in top_k], [x[1] for x in top_k])
        ...
        return self.extract_parent_nodes(top_k)
...
query = QueryBundle(query_str="DeviceLevelsPowerUp")
